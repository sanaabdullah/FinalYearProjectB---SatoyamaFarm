...
<body>
    ...
    <script>
        function MainCtrl($scope, $http){
            var data = {"xData": ["14:51:33", "14:51:43", "14:51:53", "14:54:48", "14:55:08", "14:55:09", "14:55:19", "14:58:32", "14:58:42", "14:58:52", "15:02:08", "15:02:15", "15:02:25"],"yData":[{
                "name": "Temperature",
                "data": [31, 31, 31, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30],
                color: '#e2431e'
            }, 
      ]}
    ...
    angular.module('AngularChartExample',['AngularChart'], function( $routeProvider, $locationProvider ){
        $routeProvider.when('/',{
            template: '<chart title="Satoyama Temperature Sensor" xData="lineChartXData" xname="Time Interval" yData="lineChartYData" yName="Celsius (C)" subtitle="[5th May, 2018]"></chart>',
            controller: MainCtrl
            })
    })
    </script>
